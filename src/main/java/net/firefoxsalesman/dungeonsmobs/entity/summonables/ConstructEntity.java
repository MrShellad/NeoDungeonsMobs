...
public abstract class ConstructEntity extends PathfinderMob {
	...
	public boolean hurt(DamageSource p_70097_1_, float p_70097_2_) {
		if (p_70097_1_ == damageSources().fellOutOfWorld()) {
	...
	public void spawnAreaDamage() {
		AreaDamageEntity areaDamage = AreaDamageEntity.spawnAreaDamage(level(), position(), this, 2.5F,
