...
public class MobEnchantmentAncientData {
	...
	public static final MobEnchantmentAncientData DEFAULT = new MobEnchantmentAncientData(defaultAdjectives,
			defaultNouns);

	public static final Codec<MobEnchantmentAncientData> CODEC = RecordCodecBuilder.create(builder -> builder.group(
