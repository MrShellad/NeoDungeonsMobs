...
public class UniqueAncientData {
	public static final Codec<UniqueAncientData> CODEC = RecordCodecBuilder.create(builder -> builder.group(
			Codec.STRING.fieldOf("name").forGetter(data -> data.name),
			ResourceLocation.CODEC.listOf().fieldOf("mob_enchantments")
					.forGetter(data -> data.mobEnchantments),
			ResourceLocation.CODEC.fieldOf("minion").forGetter(data -> data.minion),
			ResourceLocation.CODEC.listOf().fieldOf("minion_mob_enchantments")
					.forGetter(data -> data.minionMobEnchantments),
	...
	public UniqueAncientData(String name, List<ResourceLocation> mobEnchantments, ResourceLocation minion,
			List<ResourceLocation> minionMobEnchantments, int minionCount) {
		this.name = name;
